...
function Screen({ t, platform, dark, children, bg, scroll = false, noBottomInset = false }) {
  return (
    <div style={{ position: 'absolute', inset: 0, background: bg || t.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ position: 'absolute', top: TOP_INSET, left: 0, right: 0, bottom: noBottomInset ? 0 : (platform === 'ios' ? 22 : BOTTOM_INSET), overflow: scroll ? 'auto' : 'hidden', display: 'flex', flexDirection: 'column' }}>
        {children}
      </div>
